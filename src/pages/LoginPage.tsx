  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center gap-8 px-6">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <h1 className="text-4xl font-bold text-white tracking-widest">NABI</h1>
      ...
      <button
        ...
        className="flex items-center gap-3 bg-white text-black font-semibold px-6 py-3.5 rounded-2xl active:scale-95 transition-all"
      >
